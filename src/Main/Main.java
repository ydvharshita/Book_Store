...
public class Main
{
   ...
   public String arr[] = new String[50];
    int del_id,rem_id,car_id,i,num,del_id2 ;
    String jj,kk,ans;
   ...
   public static void main(String arg[]) throws ClassNotFoundException, SQLException
   {
    ...
    void user() throws ClassNotFoundException, SQLException
    {
        ...
        String q81 =" select mname from member; ";
        ResultSet rs11 = stmt6.executeQuery(q81);
        int flag =0;
        while(rs11.next())
        {
        ...
        if(flag==1)
        {
           String q44 =" select * from member where mname = '"+m.ch5+"';";
            ResultSet rs = stmt6.executeQuery(q44);
           
            while(rs.next())
            {
                System.out.println("\n\t<><><><> Welcome Mr/Ms. "+rs.getString(2)+" , your Id is : "+rs.getInt(1)+" <><><><> ");
            } 
        ...
        else
        {
            ...
            System.out.println("would you like to take membership?(y/n)");
            ans = h.next();
         ...
         do
       {
          ...
          switch(n)
          {
              ...
              case 2:
              {
                  ...
                  {
                        System.out.println("* SHOPPING IS ONLY FOR MEMBERS..!! *");
                        System.out.println("would you like to take membership?(y/n)");
                         ans = h.next();
                        if(ans.equalsIgnoreCase("y"))
                        {
        ...
        if((ad.pass.equalsIgnoreCase("9999")== true)&&(ad.id == 123)&&(ad.name.equalsIgnoreCase("hydv")== true))
       {
                  ...
                  if(ch.equalsIgnoreCase("n"))
            {
                 System.out.println("******************************** THANKS FOR VISITING..!!! **********************************");
                  ...
                  System.out.println("\n1-remove user\t\t\t\t\t2-show users\n3-show books\t\t\t\t\t4-add books\n5-remove books\t\t\t\t\t6-Search a book\n7-show users those having membership\t\t8-remove users those having membership\n9-exit\n");
                  int n = h.nextInt();
    ...
    void show_users() throws ClassNotFoundException, SQLException
   {
    ...
    void regis() throws ClassNotFoundException, SQLException
    {
        ...
        String q2="insert into member(mid,mname) values ( "+mem.mid+" , '"+mem.mname+"');";
        stmt1.executeUpdate(q2);
        m.opn();
       
    }
      
    void show_mem() throws ClassNotFoundException, SQLException
    {
         Class.forName("com.mysql.jdbc.Driver");
        Connection conn6 = DriverManager.getConnection("jdbc:mysql://localhost:3306/book_store","root","root");
        Statement stmt6 = conn6.createStatement();
  ...
  void rem_mem() throws ClassNotFoundException, SQLException
  {
        Class.forName("com.mysql.jdbc.Driver");
        Connection conn2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/book_store","root","root");
        Statement stmt2 = conn2.createStatement();
       ...
       System.out.println("enter the user id you wants to delete- ");
       m.del_id2 = h.nextInt();
       String q3 = "delete from member where mid="+m.del_id2+";";
       stmt2.executeUpdate(q3);
       
       stmt2.close();
       conn2.close();
  }
   void opn() throws ClassNotFoundException, SQLException
   {
         do
       {
          System.out.println("\nDo you want to continue? (y/n)");
